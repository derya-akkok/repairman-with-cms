            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    if ($_GET['durum']=="ok") { ?>
                        ...
                        <h1 style="color:blue;" class="page-subhead-line">Kayıtlar başarıyla güncellendi... </h1>
                                        ...
                                        <div class="form-group col-md-6">
                                         ...
                                         <div class="col-md-12">
                                          ...
                                          <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 100%" class="btn btn-info" type="submit" name="ayarkaydet" value="Ayarları Kaydet">
